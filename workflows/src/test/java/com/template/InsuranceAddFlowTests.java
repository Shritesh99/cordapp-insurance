...
public class InsuranceAddFlowTests {
    ...
    public void flowReturnsSignedTransaction() throws Exception {
        ...
        InsuranceAddFlow.InsuranceAddFlowInitiator flow2 = new InsuranceAddFlow.InsuranceAddFlowInitiator(insuranceCompany, hospital, "123", "1234");
